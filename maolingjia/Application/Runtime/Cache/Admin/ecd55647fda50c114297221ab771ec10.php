 ...
 <!--/sidebar-->
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">米饭管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/maolingjia/index.php/Admin/Rice/create"><i class="icon-font"></i>新增米饭</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($rice)): $i = 0; $__LIST__ = $rice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/Rice/edit');?>/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/Rice/destory');?>/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
