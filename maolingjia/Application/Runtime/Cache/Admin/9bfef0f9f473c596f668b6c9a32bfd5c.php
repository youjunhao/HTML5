 ...
 <!--/sidebar-->
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">客房分类管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="addRoom.html"><i class="icon-font"></i>新增客房分类</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($categorys)): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["catname"]); ?>"><a target="_blank" href="#" title="<?php echo ($vo["catname"]); ?>"><?php echo ($vo["catname"]); ?></a> 
                            </td>
                            <td>56</td>
                            <td>36</td>
                            <td><?php echo ($vo["price"]); ?></td>
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/Category/edit');?>/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/Category/destory');?>/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
