                                    ...
                                    <div id="tab1" class="tab active">
                                        <div id="lib_Tab1_sx" class="lib_tabborder_sx">
                                            ...
                                            <ul>
                                              ...
                                              <li id="one3" onclick="setTab('one',3,3)">冰淇淋蛋糕</li>
                                            </ul>
                                            </div>
                                        ...
                                        <div class="list-block media-list">
                                            <ul>
                                    <hr/>       <?php if(is_array($result1)): $i = 0; $__LIST__ = $result1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                        ...
                                        <div class="list-block media-list">
                                            <ul>
                                    <hr/>   <?php if(is_array($result2)): $i = 0; $__LIST__ = $result2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                                    <a href="#" class="item-content" external>
                                                        <div class="item-media"><img src="/maolingjia/Public/<?php echo ($vo["photo"]); ?>" ></div>
                                                        <div class="item-inner">
                                                            <div class="item-title-row">
                                              ...
                                              <div id="con_one_3" style="display:none">
                                                  <div class="content-block-title">冰淇淋蛋糕</div>
                                        <div class="list-block media-list">
                                            <ul>
                                    <hr/>       <?php if(is_array($result3)): $i = 0; $__LIST__ = $result3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                                    <a href="#" class="item-content" external>
                                                        <div class="item-media"><img src="/maolingjia/Public/<?php echo ($vo["photo"]); ?>" ></div>
                                                        <div class="item-inner">
                                                            <div class="item-title-row">
