                                ...
                                <div class="tabs">
                                    <div id="tab1" class="tab active">
                                        <div id="lib_Tab1_sx" class="lib_tabborder_sx">
                                            ...
                                            <ul>
                                              <li id="one1" onclick="setTab('one',1,3)" class="hover">奶茶</li>
                                              <li id="one2" onclick="setTab('one',2,3)" >冰沙</li>
                                              <li id="one3" onclick="setTab('one',3,3)">炒酸奶</li>
                                            </ul>
                                            </div>
                                             <div class="lib_Contentbox_sx "> 
                                              <div id="con_one_1" >
                                                  <div class="content-block-title">奶茶</div>
                                    ...
                                    <hr/>        <?php if(is_array($result1)): $i = 0; $__LIST__ = $result1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                              ...
                                              <div id="con_one_2" style="display:none">
                                                  <div class="content-block-title">冰沙</div>
                                        <div class="list-block media-list">
                                            <ul>
                                    <hr/>
                                              ...
                                              <div id="con_one_3" style="display:none">
                                                  <div class="content-block-title">炒酸奶</div>
                                        <div class="list-block media-list">
                                            <ul>
                                    <hr/>
