    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/Cake/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>蛋糕名称：</th>
                                <td>
                                    <input class="common-text required" id="title" name="name" size="50" value="<?php echo ($cake["name"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>已售数量：</th>
                                <td>
                                    <input class="common-text required" id="title" name="number" size="50" value="<?php echo ($cake["number"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>原价：</th>
                                <td>
                                    <input class="common-text required" id="title" name="yprice" size="50" value="<?php echo ($cake["yprice"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>现价：</th>
                                <td>
                                    <input class="common-text required" id="title" name="xprice" size="50" value="<?php echo ($cake["xprice"]); ?>" type="text">
                                </td>
                            </tr>            
                            <tr>
                                <th><i class="require-red">*</i>蛋糕图片：</th>
                                <td>
                                    <img src="/Hotelms/Public/<?php echo ($cake["photo"]); ?>" /><input name="photo" id="" type="file">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                    <input type="hidden" value="<?php echo ($cake["id"]); ?>" name="id" />
